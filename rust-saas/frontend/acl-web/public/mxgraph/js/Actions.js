...
Actions.prototype.init = function()
{
	...
	// File actions
	this.addAction('new...', function () { graph.openLink(ui.getUrl()); }).visible = false;
	...
	this.addAction('saveAs...', function () { ui.saveFile(true); }, null, null, Editor.ctrlKey + '+Shift+S').visible = false;
	this.addAction('export...', function () { ui.showDialog(new ExportDialog(ui).container, 300, 230, true, true); }).visible = false;
	...
	this.addAction('pageSetup...', function () { ui.showDialog(new PageSetupDialog(ui).container, 320, 220, true, true); }).visible = false;
	this.addAction('print...', function () { ui.showDialog(new PrintDialog(ui).container, 300, 180, true, true); }, null, 'sprite-print', Editor.ctrlKey + '+P').visible = false;;
	this.addAction('preview', function () { mxUtils.show(graph, null, 10, 10); }).visible = false;;
