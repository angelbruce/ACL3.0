...
<template>
  <div class="flex h-full flex-col">
    <div class="border-r border-surface-200 flex flex-col">
      <div class="p-2 border-b border-surface-200 justify-between items-center flex flex-row">
    ...
    <div class="w-full h-full flex flex-row">
      <div class=" h-full w-1/2">
        <FlowRunnerHuman :flowId="flowId" :flowRuntimeId="flowRuntime?.id || 0" />
      </div>
