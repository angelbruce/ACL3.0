...
pub fn create_router() -> Router {
    ...
    Router::new()
        ...
        .route("/api/projects/:project_id/file-assignments", axum::routing::get(get_file_assignments))
        .route("/api/projects/:project_id/file-assignments/assign", axum::routing::post(assign_files_to_containers))
        .route("/api/projects/:project_id/file-assignments/shared", axum::routing::get(get_shared_files))
        .route("/api/projects/:project_id/file-assignments/containers/:container_config_id", axum::routing::get(get_files_by_container))
        .route("/api/projects/:project_id/file-assignments", axum::routing::put(update_file_assignment))
        .route("/api/project-file-assignments/:file_id", axum::routing::delete(delete_file_assignment))
