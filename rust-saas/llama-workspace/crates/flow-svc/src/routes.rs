...
pub fn create_router() -> Router {
    ...
    Router::new()
        ...
        .route("/api/flows/:flow_id/nodes/:node_id/human-input", axum::routing::post(send_human_input))
        .route("/api/flow-runtimes/:runtime_id/nodes/:node_id/complete", axum::routing::post(complete_node))
        .route("/api/flow-runtimes/:runtime_id/sessions", axum::routing::get(get_flow_runtime_sessions))
        .route("/api/flow-runtimes/:runtime_id/sessions/:session_id/items", axum::routing::get(get_flow_runtime_session_items))
